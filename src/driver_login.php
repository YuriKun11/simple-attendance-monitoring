...
<body>
    ...
    <div class="auth-container">
        ...
        <form id="login-form" method="POST" action="auth_process.php">
            <h2 class="sr-only">Account Login</h2>
            
            <div class="input-group">
                <label for="login-email" class="text-sm font-medium text-gray-700 input-label">Email</label>
                <div class="input-wrapper">
                    <input type="email" id="login-email" name="email" placeholder="tourist@gmail.com"
                            class="input-field"
                            required>
         ...
         <div class="input-group">
    <label for="login-password" class="text-sm font-medium text-gray-700 input-label">Password</label>
    <div class="input-wrapper">
        <input type="password" id="login-password" name="password" placeholder="••••••••"
               class="input-field password-input"
               required>
        <svg class="input-icon" fill="currentColor" viewBox="0 0 32 32"
        ...
        <button type="button" class="password-toggle-btn" onclick="togglePasswordVisibility('login-password')">
            ...
            <div class="flex-row-between">
                <label class="remember-me-label text-gray-600">
                    <input type="checkbox" name="remember" class="form-checkbox">
                    Remember me
                </label>
                <a href="#" class="touride-blue font-medium forgot-password-link">Forgot Password?</a>
            </div>

            <button type="submit" name="driver_login_submit" class="btn-primary">
                Login
            </button>
        </form>
        ...
        <div class="toggle-section">
            ...
            <a href="./driver_register.php" class="touride-blue font-medium toggle-link">
                Register
            </a>
        </div>
    </div>
