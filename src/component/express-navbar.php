<header class="py-4 mt-4 relative z-20 sticky top-0 z-50 transition duration-300">
    <div class="mx-4 flex justify-between items-center bg-white p-3 md:p-4 rounded-xl shadow-lg shadow-blue-100/50">
        ...
        <nav class="hidden md:flex space-x-8 text-sm font-semibold text-gray-600">
            <a href="#benefits" class="hover:text-blue-600 transition duration-150 nav-link nav-link-home">Benefits</a>
            <a href="#registration" class="hover:text-blue-600 transition duration-150 nav-link nav-link-home">How it works</a>
           
        </nav>

        <a href="../driver_login.php" class="btn-login shadow-md hidden md:block">
            Login
        </a>
    ...
    <div id="mobile-menu" class="mobile-menu absolute top-full left-0 right-0 md:hidden bg-white mt-2 p-4 rounded-xl shadow-xl border border-gray-100 transform -translate-y-2 opacity-0 pointer-events-none">
        <nav class="flex flex-col space-y-3 text-base font-medium text-gray-700">
            <a href="#benefits" class="p-2 rounded-lg hover:bg-gray-50 transition duration-150 nav-link nav-link-home">Benefits</a>
            <a href="#registration" class="p-2 rounded-lg hover:bg-gray-50 transition duration-150 nav-link">How it works</a>
          
                <a href="../driver_login.php" class="btn-login-mobile">
                    Login
                </a>
        </nav>
    </div>
